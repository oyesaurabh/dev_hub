...
const MobileNavbar = () => {
  ...
  function renderNotificationBadge() {
    ...
    if (unreadNotificationsCount?.count && unreadNotificationsCount.count > 0) {
      return (
        <div className="absolute -top-2 -right-1.5 bg-primary text-white rounded-full min-w-[16px] h-4 flex items-center justify-center">
  ...
  if (isLoadingUser) {
    return (
      <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-zinc-700 h-14 flex items-center justify-center">
  ...
  return (
    <nav className="sticky md:hidden bottom-0 left-0 right-0 bg-black border-t border-zinc-700 z-50">
