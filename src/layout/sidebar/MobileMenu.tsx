  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-col w-[70%] h-full p-4 border-r border-zinc-700  bg-black z-[999]   "
      >
        <div className=" flex flex-col gap-2">
          ...
          <div className="flex flex-col -gap-1">
            <div className="flex items-center gap-1.5">
              ...
              {data?.user?.isVerified && <VerifiedBadge />}
            </div>
        ...
        <div className=" flex flex-col justify-between h-full py-5">
          <div className="flex flex-col gap-4">
            ...
            <div
              ...
              className=" flex items-center gap-3 font-semibold rounded-xl bg-primary text-white px-4 py-2 justify-center"
            >
              <FiFeather size={20} />
              Create Post
            </div>
