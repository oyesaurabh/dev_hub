...
const CreatePost = () => {
  ...
  return (
    <>
      <div className="bg-black border-b border-zinc-700 w-full max-w-[600px] p-4 h-fit">
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div className="flex justify-between items-center sticky top-0 bg-black z-10 py-2">
            <Image
              ...
              width={32}
              height={32}
              className="rounded-lg size-9 select-none object-cover bg-white"
            />
            <div className="flex gap-2 items-center">
              ...
              >
                {isLoading ? <LoaderCircle className="animate-spin" /> : "Post"}
              </button>
            </div>
          </div>
